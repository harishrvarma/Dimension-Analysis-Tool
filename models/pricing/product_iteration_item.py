...
class PricingProductIterationItem(BaseModel):
    __tablename__ = "pricing_product_iteration_item"

    id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)
    iteration_id = Column(Integer, ForeignKey("pricing_product_iteration.iteration_id"), nullable=False)
    system_product_id = Column(String(100), ForeignKey("pricing_product.system_product_id"), nullable=False)
